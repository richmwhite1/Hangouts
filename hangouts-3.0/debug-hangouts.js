...
async function debugHangouts() {
  console.log('🔍 Debugging hangouts in database...');
  ...
  try {
    ...
    // Check if there are any hangouts with specific ID from the test
    ...
    console.error('❌ Error debugging hangouts:', error);
  } finally {
