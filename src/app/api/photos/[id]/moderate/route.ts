...
export async function POST(
  ...
  try {
    ...
    switch (action) {
      case 'flag':
        return await flagPhoto(photoId, payload.userId, reason, severity, notes)
      
      case 'approve':
        return await approvePhoto(photoId, payload.userId, notes)
      
      case 'reject':
        return await rejectPhoto(photoId, payload.userId, reason, severity, notes)
      
      case 'hide':
        return await hidePhoto(photoId, payload.userId, reason, notes)
      
      case 'delete':
        return await deletePhoto(photoId, payload.userId, reason, notes)
      
      case 'restore':
        return await restorePhoto(photoId, payload.userId, notes)
