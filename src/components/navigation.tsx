              ...
              >
                <Avatar className="w-8 h-8 rounded-lg">
                  <AvatarImage 
                    ...
                    alt={isSignedIn && user?.username ? user.username : "Profile"} 
                  />
                  <AvatarFallback className="rounded-lg">
                    {isSignedIn && user?.username ? user.username.charAt(0).toUpperCase() : <User className="w-5 h-5" />}
                  </AvatarFallback>
                </Avatar>
              </Button>
                ...
                <div className="absolute right-0 top-full mt-2 w-64 bg-card border border-border rounded-lg shadow-lg z-50">
                  <div className="p-4 border-b border-border">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-sm">{isSignedIn && user?.username ? user.username : "User"}</p>
